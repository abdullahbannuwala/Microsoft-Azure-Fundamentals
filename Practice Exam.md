...
55. You are planning to use Azure Site Recovery for disaster recovery. Which of the following scenarios is NOT supported by Azure Site Recovery?
    - Options: Migrating physical servers from an on-premises data center to Azure, Replicating Azure VMs from one Azure region to another, Replicating Hyper-V VMs without VMM (Virtual Machine Manager), Replicating VMs from AWS to Azure
    - Answer: Replicating Azure VMs from one Azure region to another

56. Your organization requires that all data stored in Azure comply with the General Data Protection Regulation (GDPR). You need to recommend a feature to ensure the data is compliant. What should you recommend?
    - Options: Azure Policy, Azure Compliance Manager, Azure Information Protection, Azure Trust Center
    - Answer: Azure Compliance Manager

57. You need to deploy a new version of a web app to Azure and ensure that it can be rolled back quickly if the deployment fails. Which deployment strategy should you use?
    - Options: Blue/Green deployment, Rolling deployment, Canary deployment, A/B testing
    - Answer: Blue/Green deployment

58. A company wants to ensure that their Azure environment is optimized for cost and performance. Which Azure service should they use to achieve this goal?
    - Options: Azure Advisor, Azure Monitor, Azure Cost Management, Azure Service Health
    - Answer: Azure Advisor

59. You are tasked with securing Azure virtual machines that host sensitive data. Which of the following should you implement to ensure the data is encrypted at rest?
    - Options: Azure Active Directory, Azure Key Vault, Azure Security Center, Azure Disk Encryption
    - Answer: Azure Disk Encryption

60. Your company wants to implement a cloud-based BI solution that allows for interactive visualization and data analysis with minimal coding. Which Azure service should you use?
    - Options: Azure Analysis Services, Power BI, Azure Data Lake Analytics, Azure Synapse Analytics
    - Answer: Power BI

61. You are designing a solution in Azure that requires a relational database with minimal administrative overhead. Which service should you choose?
    - Options: Azure SQL Database, Azure Cosmos DB, Azure Blob Storage, Azure Table Storage
    - Answer: Azure SQL Database

62. Your application needs to perform complex transformations and aggregations on large datasets in real-time. Which Azure service is best suited for this task?
    - Options: Azure Data Factory, Azure Stream Analytics, Azure HDInsight, Azure Databricks
    - Answer: Azure Databricks

63. A company is planning to use Azure for hosting its applications. The company is concerned about the potential for DDoS attacks. Which Azure feature should they use to protect their applications?
    - Options: Azure Application Gateway, Azure Firewall, Azure DDoS Protection, Network Security Groups
    - Answer: Azure DDoS Protection

64. You need to ensure that your Azure resources are not accessible over the internet but can still communicate with each other. What should you implement?
    - Options: Azure Service Bus, Azure Virtual Network, Network Security Groups, Azure ExpressRoute
    - Answer: Azure Virtual Network

65. Your organization requires that all emails sent from Azure must be archived for legal reasons. Which Azure service should you use to achieve this requirement?
    - Options: Azure Blob Storage, Azure Files, Azure Queue Storage, Azure Table Storage
    - Answer: Azure Blob Storage

66. You are developing a solution that requires serverless code execution in Azure. Which service should you use?
    - Options: Azure Functions, Azure Kubernetes Service (AKS), Azure Virtual Machines, Azure App Service
    - Answer: Azure Functions

67. A company needs to deploy a global application that provides low-latency access to data from anywhere in the world. Which Azure service should they use?
    - Options: Azure CDN, Azure Cosmos DB, Azure Blob Storage, Azure Traffic Manager
    - Answer: Azure Cosmos DB

68. You are tasked with implementing a backup solution for Azure IaaS VMs that allows for point-in-time restoration. Which Azure service should you use?
    - Options: Azure Backup, Azure Site Recovery, Azure Snapshot, Azure Storage Account
    - Answer: Azure Backup

69. Your company requires a messaging service that guarantees first-in-first-out (FIFO) delivery of messages. Which Azure service should you use?
    - Options: Azure Queue Storage, Azure Service Bus, Azure Event Grid, Azure Event Hubs
    - Answer: Azure Service Bus

70. You need to implement a solution that automatically scales your Azure resources based on demand. Which Azure service provides this capability?
    - Options: Azure Monitor, Azure Logic Apps, Azure Autoscale, Azure Functions
